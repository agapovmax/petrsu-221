...
// Структура нужна чтобы при умножении на отрицательное число, оно могло поместиться в диапазон unsigned int denum после сокращения в int
typedef struct {
     int num;                // целое число от −2 147 483 648 до 2 147 483 647 (при 4 байтах)  (11 знаков)
     unsigned int denom;     // целое положительное число от 0 до 4 294 967 295 (для 4 байт)   (10 знаков)
     //unsigned long denom;     // целое число в диапазоне от 0 до 18 446 744 073 709 551 615 (8 байт)   (20 знаков)
} rational_t;
